...
data_type random_selection_0(data_type arr[], const size_type n, const size_type order) {
    auto result = selection_func(arr, n, order, random_choose_pivot);
    return result;
}

data_type deterministic_selection_0(data_type arr[], const size_type n, const size_type order) {
